...
namespace asgn5v1
{
	...
	public class Transformer : System.Windows.Forms.Form
	{
        ...
        public Transformer()
		{
			...
			Text = "COMP 4560:  Assignment 5 (200830) (Oscar Kwan)";
			ResizeRedraw = true;
        ...
        double[,] scaleMatrixInitialize(double xScale, double yScale, double zScale)
        {
        ...
        double[,] reflectionMatrixInitialize(double x, double y, double z)
        {
            double[,] reflectionMatrix = new double[4, 4];
            setIdentity(reflectionMatrix, 4, 4);

            reflectionMatrix[0, 0] = x;
            reflectionMatrix[1, 1] = y;
            reflectionMatrix[2, 2] = z;
